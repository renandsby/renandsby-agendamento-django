...
class UnidadeDeApoio(BaseModel):
    ...
    tipo_rede_apoio = models.ForeignKey("dominios.TipoRedeApoio", on_delete=models.SET_NULL, null=True, verbose_name="Tipo Rede de Apoio" )
    ...
    bairro = models.ForeignKey("dominios.Bairro", on_delete=models.SET_NULL, blank=False, null=True, verbose_name="Bairro")
