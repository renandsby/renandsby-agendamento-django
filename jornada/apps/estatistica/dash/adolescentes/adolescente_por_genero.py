...
from estatistica.extracao.adolescentes_por_genero import get_adolescentes_por_genero
from datetime import datetime


@staticmethod
def dashboard_adolescente_por_genero():
    app = DjangoDash("AdolescentePorGenero")
    df = pd.DataFrame(get_adolescentes_por_genero())
    df.columns = ["Gênero", "Quantidade"]
    ...
    fig.update_traces(
        hovertemplate="<b>Gênero:</b><b>%{x}</b><br><b>Percent:</b><b>%{text}</b><br><b>Qtd:</b><b>%{y}</b><br>",
    ...
    app.layout = html.Div(
        ...
        children=[
            ...
            html.Br(),
            dcc.Graph(id="adolescente-por-genero", figure=fig),
            html.Br(),
            html.Div(
                [
