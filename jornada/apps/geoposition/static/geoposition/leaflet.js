        ...
        $('.geoposition-widget').each(function() {
            var $container = $(this),
                ...
                mapOptions = {
                    ...
                    dataZoom: 16,
                    initialZoom: 2,
                    initialCenter: [-15.79409809243331, -47.882823942345574],
                    parentSelector: '#tabs',
                    isDjangoAdmin: false
                },
            ...
            function getLatLng() {
                latitude = parseFloat($latitudeField.val()) || -15.79409809243331;
                longitude = parseFloat($longitudeField.val()) || -47.882823942345574;
